...
//  content_ = content_.replace("LOC",location);
  ...
  var irouteLayer = new google.maps.KmlLayer('http://masaridespbp.com/PBP2011-Inbound-route.kml');
  irouteLayer.setMap(map);
  var orouteLayer = new google.maps.KmlLayer('http://masaridespbp.com/PBP2011-Outbound-route.kml');
